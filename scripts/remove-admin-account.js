...
module.exports = async function (exit) {
  ...
  try {
    ...
    const tx = await controller.removeAdminAccount(account);
    console.log("controller removeAdminAccount: ");
    console.log(tx);
    const tx2 = await validator.removeAdminAccount(account);
    console.log("blacklistValidator removeAdminAccount: ");
    console.log(tx2);
    exit(0);
  } catch (e) {
    exit(e);
