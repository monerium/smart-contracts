...
// File: contracts/ownership/CanReclaimToken.sol
...
// File: contracts/ownership/HasNoTokens.sol
...
// File: contracts/ownership/HasNoContracts.sol
...
// File: contracts/ownership/NoOwner.sol
...
// File: contracts/IPolygonPosRootToken.sol
...
// File: @openzeppelin/contracts/access/IAccessControl2.sol

// OpenZeppelin Contracts v4.4.1 (access/IAccessControl2.sol)
 ...
 */
abstract contract AccessControl is Context, IAccessControl2, ERC165 {
    struct RoleData {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return interfaceId == type(IAccessControl2).interfaceId || super.supportsInterface(interfaceId);
    }
...
/**
 * @dev Interface for interacting with the SmartController from TokenFrontend.
 */
interface ISmartController {
    function transfer_withCaller(address from, address to, uint256 amount) external returns (bool);
    function transferFrom_withCaller(address sender, address from, address to, uint256 amount) external returns (bool);
    function approve_withCaller(address owner, address spender, uint256 amount) external returns (bool);
    function transferAndCall_withCaller(address from, address to, uint256 amount, bytes calldata data) external returns (bool);
    function mintTo_withCaller(address caller, address to, uint256 amount) external returns (bool);
    function burnFrom_withCaller(address caller, address from, uint256 amount, bytes32 h, uint8 v, bytes32 r, bytes32 s) external returns (bool);
    function recover_withCaller(address caller, address from, address to, bytes32 h, uint8 v, bytes32 r, bytes32 s) external returns (uint256);
    function isFrontend(address frontend) external view returns (bool);
    function ticker() external view returns (bytes3);
    function totalSupply() external view returns (uint256);
    ...
    AccessControl
{
    ...
    ISmartController internal controller;
    ...
    function setController(address address_) external onlyOwner {
        ...
        controller = ISmartController(address_);
        require(
